  ...
  return (
    <section className="flex min-h-screen max-w-350 m-auto flex-col items-center justify-center px-4 py-24 sm:py-28 own:px-0 lg:py-32">
      ...
      <div className="max-w-110 w-full bg-slate-50 border border-slate-200 rounded-lg p-6 mb-4">
        ...
        <div className="flex flex-col justify-between sm:flex-row"><strong>{t.impressum.page_owner.address}</strong><p>2013 Pomáz</p></div>
        <div className="flex flex-col justify-between sm:flex-row"><strong>{t.impressum.page_owner.phone}</strong><p>06-30-854-4452</p></div>
        <div className="flex flex-col justify-between sm:flex-row"><strong>{t.impressum.page_owner.email}</strong><p>info@thomashorvath.hu</p></div>
      </div>
      ...
      <div className="max-w-110 w-full bg-slate-50 border border-slate-200 rounded-lg p-6">
        ...
        <div className="flex flex-col justify-between sm:flex-row"><strong>{t.impressum.hosting_provider.website}</strong><p> <Link className="text-sky-500 underline hover:text-sky-700" href="https://www.nethely.hu" target="_blank" rel="noopener noreferrer">https://www.nethely.hu</Link></p></div>
        <div className="flex flex-col justify-between sm:flex-row"><strong>{t.impressum.hosting_provider.contact_page}</strong><p> <Link className="text-sky-500 underline hover:text-sky-700" href="https://www.nethely.hu/rolunk" target="_blank" rel="noopener noreferrer">https://www.nethely.hu/rolunk</Link></p></div>
      </div>
    </section>
  )
}
